...
namespace iDSControl
{
    public partial class CameraChoose : Form
    {
        ...
        private void listViewCamera_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                m_CameraCanUse = listViewCamera.SelectedItems[0].SubItems[0].Text == "Yes";
                ...
                m_SerialNumber = listViewCamera.SelectedItems[0].SubItems[4].Text;
        ...
        public static Int32 GetDeviceID_From_SerialNumber(string strSerialNumber)
        {
            uEye.Types.CameraInformation[] cameraList;
            uEye.Info.Camera.GetCameraList(out cameraList);
            ...
            foreach (uEye.Types.CameraInformation info in cameraList)
            {
                if (strSerialNumber == info.SerialNumber)
